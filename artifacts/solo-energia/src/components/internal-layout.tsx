...
import { Users2, Package, Sun, KanbanSquare, Wrench, FileCheck2, LogOut, LayoutDashboard, Users, Truck, Wallet, MessageSquareText, Handshake } from "lucide-react";
...
const NAV = [
  ...
  { href: "/interno/indicacoes", label: "Indicações", icon: Handshake },
